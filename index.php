...
<body>
    <div class="acceuille container-fluid"><!--Ici premiere partie de la page-->
        <div class="row">
            <div class="titre col-sm-12 col-md-6 text-center order-2">
                <h1 id="h1"></h1>
                <p>We rasberry Py</p>
                <img class="img"src="Assets/img/hackers-poulette-logo.png" alt="logo,text,image">
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="formulaire col-md-12 col-sm-12 text-center">
                <h1>Besoin de reponse a vos question ? voici un formulaire</h1>
                <p>Le formulaire ce trouvera ici :smile:</p>
            </div>
        </div>
    </div>
