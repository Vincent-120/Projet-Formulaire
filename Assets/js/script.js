...
function controlvide() {
  for (i=0; i<document.getElementsByTagName("sexe").length; i++)
  if (document.getElementsByTagName("sexe")[i].name=="test_radio")
  if (document.getElementsByTagName("sexe")[i].checked) {
  return true;
  }
  else
  {
